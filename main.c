...
int	color_map_2(unsigned char *data,int bpp,int sl,int w,int h,int endian,
		int type, void *mlx, int local_endian);

int	expose_win1(void *p, void *mlx, void *win1, void *im3)
{
  mlx_put_image_to_window(mlx,win1,im3,0,0);
}

int	expose_win2(void *p, void *mlx, void *win2, void *im2, void *im4)
{
...
int	key_win3(int key,void *p, void *mlx, void * win3)
{
...
int	main()
{
  ...
  color_map_1(win1,WIN1_SX,WIN1_SY, mlx);
  printf("OK\n");
  sleep(2);
  ...
  printf(" => Fill Image1 ...");
  color_map_2(data1,bpp1,sl1,IM1_SX,IM1_SY,endian1, 1, mlx, local_endian);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im1)->pix);
  ...
  printf(" => Fill Image3 ...");
  color_map_2(data3,bpp3,sl3,IM3_SX,IM3_SY,endian3, 1, mlx, local_endian);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im3)->pix);
  ...
  color_map_2(data4,bpp4,sl4,IM3_SX,IM3_SY,endian4, 2, mlx, local_endian);
